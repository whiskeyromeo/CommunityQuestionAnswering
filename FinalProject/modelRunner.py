...
for file in filenames:
	if 'subtaskA' in file:
		os.system("gnome-terminal -e 'bash -c \"python \'print "+ file +"\';python ./scorer/MAP_scripts/ev.py ./scorer/SemEval2016-Task3-CQA-QL-dev-subtaskA.xml.subtaskA.relevancy ./models/" + file +";exec bash\"'")
	else:
